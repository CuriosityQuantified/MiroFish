...
Implements simple command/response pattern via filesystem:
...
class SimulationIPCClient:
    ...
    def send_command(
        ...
        # timeout
        logger.error(f"等待IPC响应timeout: command_id={command_id}")
        ...
        raise TimeoutError(f"等待命令响应timeout ({timeout}秒)")
