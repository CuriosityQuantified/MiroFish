...
class SimulationRunner:
    ...
    def start_simulation(
        ...
        try:
            ...
            # If max_rounds is specified, add it to the command-line arguments
            if max_rounds is not None and max_rounds > 0:
            ...
            # Set working directory to the simulation directory (databases etc. will be created there)
    ...
    def _monitor_simulation(cls, simulation_id: str):
        ...
        try:
            ...
            # After process ends, read the logs one final time
            if os.path.exists(twitter_actions_log):
                ...
                for line in f:
                    ...
                    if line:
                        try:
                            ...
                            # Process entries with event_type
                            if "event_type" in action_data:
                                ...
                                # Update round information (from round_end event)
                                    ...
                                    # Overall round is the maximum of the two platforms
                                    if round_num > state.current_round:
                                        state.current_round = round_num
                                    # Overall time is the maximum of the two platforms
        ...
        with open(file_path, 'r', encoding='utf-8') as f:
            for line in f:
                ...
                try:
                    ...
                    # Get platform: use the record's own platform first, fall back to default
    ...
    def cleanup_simulation_logs(cls, simulation_id: str) -> Dict[str, Any]:
        """
        Clean up simulation run logs (used to force a fresh restart of simulation)
    ...
    def register_cleanup(cls):
        ...
        # If not in debug mode, this env var won't exist, but cleanup still needs to be registered
    ...
    def interview_agent(
        ...
        Args:
            ...
            platform: Specify platform (optional)
                ...
                - None: For dual-platform simulations, interview both platforms and return merged result
    ...
    def interview_agents_batch(
        ...
        Args:
            ...
            platform: Default platform (optional, will be overridden by each interview item's platform)
                ...
                - None: For dual-platform simulations, each Agent is interviewed on both platforms
            timeout: Timeout in seconds
    ...
    def get_interview_history(
        ...
        Args:
            ...
            agent_id: Specify Agent ID (optional, get history for that Agent only)
