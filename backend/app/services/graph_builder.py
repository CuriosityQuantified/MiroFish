...
class GraphBuilderService:
    ...
    def set_ontology(self, graph_id: str, ontology: Dict[str, Any]):
        ...
        # Required by Zep SDK, warning from dynamic class creation, can be safely ignored
    ...
    def _wait_for_episodes(
        ...
        """Wait for all episodes to be processed (by querying each episode processed status)"""
